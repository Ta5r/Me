      ...
      >
        <Container maxW={'7xl'} py={16} as={Stack} spacing={12}>
          <Stack spacing={0} align={'center'}>
            ...
            >
              <code>People I have worked with</code>
            </Heading>
            <Text
              py={'1rem'}
              px={['2rem', '5rem']}
            ...
            >
              I have been working with people around the globe.
            </Text>
          </Stack>
          <SimpleGrid columns={[1, 2, 3, 4]} spacingX="2rem" spacingY={'2rem'}>
            {data_testimonial.map(res => (
              <Testimonial>
                <TestimonialContent>
                  <TestimonialHeading>{res.heading}</TestimonialHeading>
                  <TestimonialText>{res.text}</TestimonialText>
                </TestimonialContent>
                <TestimonialAvatar
                  src={res.img}
                  name={res.name}
