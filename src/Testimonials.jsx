    ...
    <Box 
      ...
      <Container maxW={'7xl'} py={16} as={Stack} spacing={12}>
        ...
        <Heading
          ...
          <Text py={"1rem"} px={["2rem","5rem"]} fontSize={["large","xl","2xl"]}>I have been working with clients around the world.</Text>
        </Stack>
        <SimpleGrid columns={[1,2,3,4]} spacingX="2rem" spacingY={"2rem"}>
